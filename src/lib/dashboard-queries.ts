...
/**
 * Дневная норма выдачи лидов Tier 4 (≈30/день). UI-first: используется и как размер
 * «выданных», и как счётчик в напоминаниях. С lead-select (#14) заменится реальной
 * выдачей из LeadDelivery по дню.
 */
