...
const SCHEDULE: Job[] = [
  ...
  // Динамика базы — три ведра: расставляет все обогащённые компании по active_lead/recheck_later/dead.
  // Полный проход (~124k строк), курсором/пачками по 500. Запускается ночью после окончания enrich-волны.
  // Anti-overlap: если предыдущий прогон ещё идёт (маловероятно, но страховка) — пропускаем.
  { name: 'recheck', cron: '30 4 * * *' },
];
